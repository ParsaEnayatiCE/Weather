...
struct FetchData{
    ...
    func getWeatherObject(weatherData : WeatherData) -> cityWeather {
        return cityWeather(lat: weatherData.coord.lat, lon: weatherData.coord.lat, name: weatherData.name, highTemp: "\(weatherData.main.temp_max)", lowTemp: "\(weatherData.main.temp_min)", icon: "sun.max.fill")
    }
